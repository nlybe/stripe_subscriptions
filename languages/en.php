...
return [
	...
	'subscriptions:plans:product_id' => 'Product ID',
	'subscriptions:plans:product_id:help' => 'Provide the corresponded Product ID, as taken from Stripe after created a product.',
	...
	'subscriptions:plans:edit:error_required_field_empty' => 'Please check that you have filled out all the required fields and set a valid amount to be charged.',
